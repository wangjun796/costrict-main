 ...
 *
 * This class manages the state for the marketplace view in the ssdAgent extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ssdAgent extensions interface
