			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						ssdAgent Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how ssdAgent, Inc. (&quot;ssdAgent,&quot; &quot;we,&quot;
					...
					<ul className="lead">
						...
						<li>
							create an account for, sign in to, or otherwise use <strong>ssdAgent Cloud</strong> at{" "}
							<strong>costrict.ai</strong> or through the ssdAgent extension while authenticated to that
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the ssdAgent extension <strong>without</strong> connecting to a Cloud account,
							...
							<a
								...
								ssdAgent Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit ssdAgent servers unless you explicitly choose ssdAgent
								as a model provider (proxy mode).
							</strong>{" "}
							When ssdAgent Cloud is your model provider, your code briefly transits ssdAgent servers only
							...
							TLS—to the model you select. ssdAgent never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in ssdAgent Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate ssdAgent Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure ssdAgent Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or CssdAgentroxy
										mode; transit‑only) when you select ssdAgent as the provider
									</td>
									<td className="border border-border px-4 py-2">
										ssdAgent servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										ssdAgent Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										ssdAgent servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on ssdAgent servers.
						</li>
						<li>
