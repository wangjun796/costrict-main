...
This package provides IPC functionality for ssdAgent, allowing external applications to communicate with the extension through a socket-based interface.
