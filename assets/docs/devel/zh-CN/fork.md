...
ssdAgent项目遵循 Angular 规范：[ssdAgent项目 commit message 规范](./commit-message.md)

ssdAgent项目采用 Github Forking 工作流。
...
提交到远程仓库以后，就可以发出 pull request 到 main 分支，后面由 ssdAgent项目的 Maintainer 进行代码 Review，并 Merge 到主干代码。
