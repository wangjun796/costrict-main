...
ssdAgent is an open-source project developed and maintained by a community of friendly users, contributors, committers, and Project Management Committee (PMC) members.
...
This document serves as a guide for new community members to start contributing to the ssdAgent project.
...
The ssdAgent project follows the GitHub Forking workflow:
[ssdAgent Contribution Process](./fork.md)

## Commit Message Conventions

The project adheres to Angular conventions:
[ssdAgent Commit Message Guidelines](./commit-message.md)
